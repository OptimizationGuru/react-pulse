	 ...
	 const restaurants = [
		{
			...
			analytics: {
				context: "seo-data-1b9da566-5f73-4d0d-84ee-4c217eae4ee6"
			},
			cta: {
		...
		},
		{
			info: {
				...
				availability: {
					nextCloseTime: "2023-12-30 03:00:00",
					opened: true
				},
				badges: {},
				isOpen: true,
		...
		},
		{
			...
			cta: {
				link: "https://www.swiggy.com/restaurants/al-bek-sampige-road-malleshwaram-bangalore-252332",
				text: "RESTAURANT_MENU",
				type: "WEBLINK"
			},
			widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
